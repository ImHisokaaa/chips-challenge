...
public class Item{
    ...
    public Image getImage(){
        return switch (this.symbol){
            ...
            case 'f' -> new Image(getClass().getResourceAsStream("/ccprog3/chipschallenge/images/fireShow.png"));
            ...
            case 'a' -> new Image(getClass().getResourceAsStream("/ccprog3/chipschallenge/images/acidShoes.png"));
